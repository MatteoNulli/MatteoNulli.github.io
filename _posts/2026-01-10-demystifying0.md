...
Finally, we put all the pieces together. We describe the classic VLM pipeline during inference, as depicted in [Figure 1](#figure-1).
...
# <small>De-mystifying Multimodal Learning</small><br>Enabiling Vision in Language Models
